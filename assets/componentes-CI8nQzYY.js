import{j as s}from"./vendor-gzd0YkcT.js";import{e as p}from"./main-DTbirat5.js";import{wi as d}from"./wicode-8gcv6svA.js";const e=[d],n=c=>`
  ...
  <section class="cp_card" id="cp_${c.id}" style="--cc:${c.color}" data-nom="${c.nom.toLowerCase()} ${c.id}">
    <div class="cp_card_head">
      ...
      <div class="cp_card_info"><h3>${c.fn.name}</h3><span class="cp_badge">v${c.fn.v}</span></div>
