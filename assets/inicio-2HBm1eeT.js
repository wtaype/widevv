...
<div class="ini_wrap">
  ...
  <section class="ini_hero">
    <div class="ini_hero_content">
      ...
      <div class="ini_roles" style="--d:.36s">
        ${h.map((i,s)=>`<span class="ini_role${s===0?" active":""}">${i}</span>`).join("")}
      </div>

      <p class="ini_sub" style="--d:.54s">
        ${n} es un ecosistema completo: utilidades JS + SPA router + temas + auth + blog.
    ...
    <div class="ini_hero_visual">
      <div class="ini_code_card" style="--d:.3s">
        ...
        <pre class="ini_code_pre">${y}<span class="ini_cursor"></span></pre>
        <div class="ini_code_footer">
          <span ${a("Vite 7")}><i class="fas fa-bolt"></i> Vite</span>
          <span ${a("Firebase 12")}><i class="fas fa-fire"></i> Firebase</span>
          <span ${a("jQuery 4")}><i class="fab fa-js"></i> jQuery</span>
        </div>
      </div>
      <div class="ini_ftech ini_ft1" style="--d:.5s"  ${a("Componentes")}><i class="fas fa-cubes"></i></div>
      <div class="ini_ftech ini_ft2" style="--d:.65s" ${a("Utilidades")}><i class="fas fa-wand-magic-sparkles"></i></div>
      <div class="ini_ftech ini_ft3" style="--d:.8s"  ${a("Modales")}><i class="fas fa-window-restore"></i></div>
      <div class="ini_ftech ini_ft4" style="--d:.95s" ${a("Temas")}><i class="fas fa-palette"></i></div>
    </div>
  </section>
  ...
  <section class="ini_eco_sec">
    ...
    <div class="ini_eco_grid">${w.map(F).join("")}</div>
  </section>
  ...
  <section class="ini_about_sec">
    <div class="ini_sec_head">
      <h2 class="ini_sec_tit">¿Por qué <span class="ini_grad">${n}?</span></h2>
      <div class="ini_sec_line"></div>
    </div>
  ...
  <section class="ini_cta_sec">
    <div class="ini_cta_wrap">
      ...
      <h2>¿Listo para construir con ${n}? 🚀</h2>
      <p>Explora la documentación y domina el framework ✨</p>
      <div class="ini_cta_chips">
        ${d.map(i=>`<a href="/${i.id}" class="ini_chip" style="--cc:${i.color}" ${a(i.desc)}><i class="fas ${i.icon}"></i> ${i.nombre}</a>`).join("")}
      </div>
      <p class="ini_cta_autor">Hecho con ❤️ por <a href="${m}" target="_blank" rel="noopener">${f}</a> © ${b()}</p>
    </div>
  </section>

</div>`;let r=null;const T=()=>{let i=0;const s=o(".ini_role");r=setInterval(()=>{s.removeClass("active"),s.eq(i=(i+1)%s.length).addClass("active")},2800),e("#in_stats",()=>{o(".ini_stat_n").each(function(){const c=o(this),t=+c.data("target"),_=c.data("sufijo")||"";let l=0;const p=setInterval(()=>{l+=t/50,l>=t?(c.text(t+_),clearInterval(p)):c.text(Math.floor(l))},28)})}),e(".ini_cat_card",null,{anim:"wi_fadeUp",stagger:80}),e(".ini_about_card",null,{anim:"wi_fadeUp",stagger:140}),e(".ini_cta_wrap",null,{anim:"wi_fadeUp"}),e(".ini_sec_head",null,{anim:"wi_fadeUp"}),e(".ini_eco_card",null,{anim:"wi_fadeUp",stagger:100}),console.log(`🚀 ${n} ${v} · Inicio OK`)},U=()=>{clearInterval(r),o(document).off(".inicio")};export{U as cleanup,T as init,E as render};
