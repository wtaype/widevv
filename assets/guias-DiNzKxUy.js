import{j as a}from"./vendor-gzd0YkcT.js";import{v as d,e as u,d as o,a as p}from"./main-B9pTXPbR.js";const n=[{id:"instalacion",icon:"fa-download",color:"#0EBEFF",nombre:"Instalación"},{id:"estructura",icon:"fa-folder-tree",color:"#FFB800",nombre:"Estructura"},{id:"temas",icon:"fa-palette",color:"#7000FF",nombre:"Temas"},{id:"rutas",icon:"fa-route",color:"#29C72E",nombre:"Rutas SPA"},{id:"paginas",icon:"fa-file-code",color:"#FF5C69",nombre:"Crear Páginas"},{id:"firebase",icon:"fa-fire",color:"#ff6d00",nombre:"Firebase"},{id:"deploy",icon:"fa-rocket",color:"#00D4FF",nombre:"Deploy"},{id:"tips",icon:"fa-lightbulb",color:"#FFB800",nombre:"Tips & Trucos"}],g={instalacion:`# 1. Clona el proyecto
...
wiDate(Timestamp).get(doc.fecha, 'full');`},v=s=>`
  <a href="#gu_${s.id}" class="gu_side_item" data-cat="${s.id}" style="--cc:${s.color}">
    <i class="fas ${s.icon}"></i>
    <span>${s.nombre}</span>
  </a>`,m=s=>{const t=["instalacion","estructura","deploy"].includes(s.id)?"bash":["temas"].includes(s.id)?"css":"js",i={instalacion:"npm · Vite · 3 comandos y listo",estructura:"Organización del proyecto completo",temas:"5 temas de color con CSS variables",rutas:"Router SPA personalizado — WiRutas",paginas:"render() + init() + cleanup()",firebase:"Auth + Firestore + Hosting",deploy:"Build + Firebase deploy + Git tags",tips:"Atajos y funciones útiles del día a día"};return`
  <section class="gu_section" id="gu_${s.id}">
    <div class="gu_sec_head" style="--cc:${s.color}">
      ...
      <div>
        ...
        <span class="gu_sec_meta">${i[s.id]||""}</span>
      </div>
    </div>
    ...
    <div class="gu_code_wrap">
      <div class="gu_code_head"><span><i class="fas fa-code"></i> ${s.id==="estructura"?"Árbol":"Código"}</span><span class="gu_lang">${t.toUpperCase()}</span></div>
      <pre><code class="language-${t}">${g[s.id]}</code></pre>
    </div>
  </section>`},h=()=>`
<div class="gu_wrap">
  ...
  <header class="gu_header">
    ...
    <div class="gu_header_stats">
      <div class="gu_hstat"><span class="gu_hstat_n">${n.length}</span><span>Guías</span></div>
      <div class="gu_hstat"><span class="gu_hstat_n">3</span><span>Comandos</span></div>
      <div class="gu_hstat"><span class="gu_hstat_n">${d}</span><span>Versión</span></div>
    </div>
  </header>
...
</div>`,b=()=>{window.Prism&&Prism.highlightAll(),u("pre code"),a(document).on("click.gu",".gu_side_item",function(i){i.preventDefault(),a(".gu_side_item").removeClass("active"),a(this).addClass("active");const e=a(a(this).attr("href"));e.length&&a("html,body").animate({scrollTop:e.offset().top-80},400)});const s=a(".gu_section"),t=()=>{const i=a(window).scrollTop()+120;s.each(function(){const e=a(this),c=e.offset().top,r=c+e.outerHeight();if(i>=c&&i<r){const l=e.attr("id")?.replace("gu_","");a(".gu_side_item").removeClass("active"),a(`.gu_side_item[data-cat="${l}"]`).addClass("active")}})};a(window).on("scroll.gu",t),t(),a(".gu_side_item").first().addClass("active"),o(".gu_section",null,{anim:"wi_fadeUp",stagger:120}),o(".gu_step",null,{anim:"wi_fadeUp",stagger:80}),o(".gu_theme_card",null,{anim:"wi_fadeUp",stagger:60}),o(".gu_tip_card",null,{anim:"wi_fadeUp",stagger:60}),console.log(`⚡ ${p} ${d} · Guías OK`)},w=()=>{a(document).off(".gu"),a(window).off(".gu")};export{w as cleanup,b as init,h as render};
