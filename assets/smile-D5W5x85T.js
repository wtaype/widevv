import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-CFiD5hzS.js";import{k as y,q as x,w as M,c as S,f as k,d as b,h as D,l as N}from"./firebase-BOfkfuSs.js";import{N as c,w as q,a as A,S as I,f as d,j as T}from"./main-Ds7-cE86.js";let r=[],m=null,o=null;const C="wi_mensajes_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},w=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},V=()=>{const{nombre:a="",usuario:e="",email:t=""}=p(),i=a||e||t||_.currentUser?.email||"";return`
