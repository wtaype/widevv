import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as h}from"./firebase-DeSmbfUu.js";import{l as y,q as x,w as M,c as S,b as k,d as b,e as D,m as N}from"./firebase-BEkkiCuJ.js";import{t as q,w as A,a as T,S as H,f as d,j as I,N as c}from"./main-DChdSc2D.js";let r=[],m=null,o=null;const C="wi_mensajes_cache",p=()=>I("wiSmile")||{},J=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},w=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const a=p();if(!a.email)return location.replace("/"),"";const{nombre:t="",usuario:e="",email:i=""}=a,n=t||e||i||_.currentUser?.email||"";return`
