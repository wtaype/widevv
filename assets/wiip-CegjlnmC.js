import{j as o}from"./vendor-gzd0YkcT.js";import{o as d,w as t,k as n}from"./main-DChdSc2D.js";const i="#0EA5E9",c={id:"wiip",fn:d,nom:"Sistema de IP",icon:"fa-globe",color:i,desc:"Obtiene la IP y datos geograficos del usuario. Cache con localStorage para evitar llamadas extras.",code:`const ip = await wiIp();
...
// ip1.query === ip2.query → true`,demo:()=>`<div class="wip_demo">
  ...
  <section class="doc_sec" id="${a.id}">
    ...
    <div class="doc_tabs">${p("js",`dp_j_${a.id}`,a.js)}</div>
    <div class="doc_demo">
...
</div>`,u=()=>{window.Prism&&Prism.highlightAll(),o(document).on("click.wip",".doc_nav_a",function(a){a.preventDefault();const s=o(o(this).attr("href"));s.length&&o("html,body").animate({scrollTop:s.offset().top-80},300),o(".doc_nav_a").removeClass("active"),o(this).addClass("active")}).on("click.wip",".doc_copy",function(){t(o(`#${o(this).data("pre")}`).text(),this,"¡Copiado!")}),n(e.map(a=>a.id),".doc_nav_a")},m=()=>o(document).off(".wip");export{m as cleanup,u as init,w as render,c as wi};
