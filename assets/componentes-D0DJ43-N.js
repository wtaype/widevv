...
wicopy('.mi-parrafo');`},u=o=>`
  <div class="cp_card" id="cp_${o.id}" style="--cc:${o.color}">
    ...
    <div class="cp_code_wrap">
      ...
      <pre><code class="language-js">${f[o.id.replace("es","").replace("iones","ion").replace("ajes","aje")]||""}</code></pre>
    </div>
...
<div class="cp_wrap">
  ...
  <div class="cp_grid">${e.map(u).join("")}</div>
