    ...
    <div class="ini_hero_visual">
      <div class="ini_planner_preview" style="--d:.3s">
        ...
        <div class="ini_prev_cols">
          <div class="ini_prev_left">${w.map(C).join("")}</div>
