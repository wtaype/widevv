import $ from 'jquery';
import {app, lanzamiento, autor, linkme, version} from './wii.js';
...
function footer(){
  ...
  <footer class="foo wb txc psa">
    <span>Creado con <i class="fas fa-heart"></i> by <a class="ftx lkme" href="${linkme}" target="_blank">${autor}</a></span>
