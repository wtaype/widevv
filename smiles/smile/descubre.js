...
// ============================================================
const stats = [
  { num: '7',    label: 'Módulos',            icon: 'fa-layer-group',    color: '#0EBEFF' },
  { num: '6',    label: 'Vistas únicas',       icon: 'fa-eye',            color: '#7000FF' },
  { num: '100%', label: 'Gratis',              icon: 'fa-heart',          color: '#FF5C69' },
  { num: year(), label: 'Actualizado',         icon: 'fa-calendar-check', color: '#29C72E' },
];

const modulos = [
  { icon: 'fa-calendar-week', color: '#0EBEFF', label: 'Horario',  desc: 'Calendario semanal visual', url: '/horario'  },
  { icon: 'fa-folder-open',   color: '#FF5C69', label: 'Tareas',   desc: 'Tablero Kanban Scrum',      url: '/tareas'   },
  { icon: 'fa-rocket',        color: '#29C72E', label: 'Planes',   desc: 'Metas y proyectos',         url: '/planes'   },
  { icon: 'fa-table-cells',   color: '#7000FF', label: 'Semanal',  desc: '7 días de un vistazo',      url: '/semanal'  },
  { icon: 'fa-calendar-days', color: '#FFB800', label: 'Mes',      desc: 'Calendario mensual',        url: '/mes'      },
  { icon: 'fa-trophy',        color: '#FF8C00', label: 'Logros',   desc: 'XP y reconocimientos',      url: '/logros'   },
  { icon: 'fa-circle-info',   color: '#A855F7', label: 'Acerca',   desc: 'Sobre Winwii',              url: '/acerca'   },
];

const beneficios = [
  { icon: 'fa-calendar-week', color: 'Cielo', titulo: 'Horario Visual Inteligente',
    desc: 'Organiza tu semana con un calendario de arrastrar y soltar. Bloques de tiempo claros, colores por tipo de actividad y sincronización en tiempo real.' },
  { icon: 'fa-folder-open',   color: 'Dulce', titulo: 'Tareas Estilo Scrum',
    desc: 'Un tablero Kanban profesional con 4 columnas: Pendiente, En Progreso, Revisión y Hecho. Mueve tus tareas con fluidez total.' },
  { icon: 'fa-rocket',        color: 'Paz',   titulo: 'Metas con Seguimiento',
    desc: 'Define planes, establece pasos y mide tu avance. Indicadores de progreso visuales que te muestran qué tan cerca estás de tus objetivos.' },
  { icon: 'fa-table-cells',   color: 'Mora',  titulo: 'Vista Semanal 7 Días',
    desc: 'Tu semana completa en una sola pantalla. Compara la carga por día, identifica días libres y distribuye actividades con inteligencia.' },
  { icon: 'fa-calendar-days', color: 'Cielo', titulo: 'Calendario Mensual',
    desc: 'Navega por cualquier mes del año. Agrega eventos con categoría, color y prioridad. Tu agenda mensual siempre organizada.' },
  { icon: 'fa-trophy',        color: 'Dulce', titulo: 'Sistema de Logros & XP',
    desc: 'Registra tus éxitos, gana XP y sube de nivel. Insignias automáticas, timeline de logros y estadísticas de tu progreso personal.' },
];

const pasos = [
  { num: '1', icon: 'fa-calendar-week', titulo: 'Organiza tu horario', desc: 'Agrega tus actividades semanales con el calendario visual y gestiona tu tiempo al detalle.' },
  { num: '2', icon: 'fa-list-check',    titulo: 'Gestiona tus tareas',  desc: 'Crea, prioriza y mueve tareas en tu tablero Kanban. De pendiente a completado con un clic.' },
  { num: '3', icon: 'fa-trophy',        titulo: 'Registra tus logros',  desc: 'Celebra cada éxito, acumula XP y construye tu historial de productividad personal.' },
];

const testimonios = [
  { avatar: '👩‍💼', nombre: 'Ana Rodríguez',  rol: 'Project Manager',
    texto: 'El tablero Kanban de Winwii es exactamente lo que necesitaba. Simple, elegante y sincronizado con la nube.', estrellas: 5 },
  { avatar: '👨‍🎓', nombre: 'Luis Paredes',   rol: 'Estudiante de Ingeniería',
    texto: 'Uso el módulo de Semanal para distribuir mis estudios. Ver los 7 días juntos me ayuda a balancear perfectamente.', estrellas: 5 },
  { avatar: '👩‍💻', nombre: 'Valeria Castro',  rol: 'Diseñadora Freelance',
    texto: 'El sistema de logros con XP me mantiene motivada. Es como un juego de productividad que funciona de verdad.', estrellas: 5 },
  { avatar: '👨‍🏢', nombre: 'Rodrigo Huanca', rol: 'Emprendedor',
    texto: 'Organizo mis proyectos con Planes y mis reuniones con el Horario. Todo integrado y con un diseño increíble.', estrellas: 5 },
];
...
<div class="dc_wrap">
  ...
  <section class="dc_sec">
    ...
    <div class="dc_cat_grid">
      ${modulos.map(m => `
        <a href="${m.url}" class="dc_cat_card wi_fadeUp" style="--cc:${m.color}">
          <div class="dc_cat_ico"><i class="fas ${m.icon}"></i></div>
      ...
      <div class="dc_cta_inner">
        ...
        <div class="dc_cta_chips">
          ${modulos.slice(0,6).map(m=>`
            <a href="${m.url}" class="dc_chip" style="--cc:${m.color}" ${wiTip(m.desc)}>
