import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-DjzZ-LRz.js";import{n as y,q as x,w as M,e as S,j as k,d as b,k as D,p as N}from"./firebase-CTdG4pYI.js";import{N as c,w as q,d as A,S as I,g as d,n as T}from"./main-RzwMgZMp.js";let r=[],m=null,o=null;const C="wi_mensajes_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},w=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},V=()=>{const{nombre:a="",usuario:e="",email:t=""}=p(),i=a||e||t||_.currentUser?.email||"";return`
