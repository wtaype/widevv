...
// Todo esto ya viene integrado automáticamente`},k=s=>`
  <a href="#mod_${s.id}" class="mod_side_item" data-cat="${s.id}" style="--cc:${s.color}">
    <i class="fas ${s.icon}"></i>
    <span>${s.nombre}</span>
  </a>`,M=s=>`<span class="mod_param"><code>${s.n}</code><em>${s.t}</em>${s.d}</span>`,C=s=>`
  <div class="mod_fn">
    <div class="mod_fn_head">
      <code class="mod_fn_name">${s.nombre}</code>
      <span class="mod_fn_ret"><i class="fas fa-arrow-right"></i> ${s.retorno}</span>
    </div>
    <p class="mod_fn_desc">${s.desc}</p>
    ${s.params.length?`<div class="mod_params"><div class="mod_params_tit"><i class="fas fa-sliders"></i> Parámetros</div>${s.params.map(M).join("")}</div>`:""}
    <div class="mod_code_wrap">
      <div class="mod_code_head"><span><i class="fas fa-code"></i> Ejemplo</span><span class="mod_lang">JS</span></div>
      <pre><code class="language-js">${s.ejemplo}</code></pre>
    </div>
  </div>`,z=()=>`
<div class="mod_wrap">
  ...
  <header class="mod_header">
    ...
    <div class="mod_header_stats">
      ...
      <div class="mod_hstat"><span class="mod_hstat_n">${p.length}</span><span>Ejemplos</span></div>
  ...
  <section class="mod_section" id="mod_basico">
    ...
    <div class="mod_code_wrap">
      ...
      <pre><code class="language-markup">${o.basico}</code></pre>
    </div>
  </section>
  ...
  <section class="mod_section" id="mod_formulario">
    ...
    <div class="mod_code_wrap">
      <div class="mod_code_head"><span><i class="fas fa-code"></i> Código</span><span class="mod_lang">HTML + JS</span></div>
      <pre><code class="language-markup">${o.formulario}</code></pre>
    </div>
  </section>
  ...
  <section class="mod_section" id="mod_confirmacion">
    ...
    <div class="mod_code_wrap">
      <div class="mod_code_head"><span><i class="fas fa-code"></i> Código</span><span class="mod_lang">HTML + JS</span></div>
      <pre><code class="language-markup">${o.confirmacion}</code></pre>
    </div>
  </section>
  ...
  <section class="mod_section" id="mod_galeria">
    ...
    <div class="mod_code_wrap">
      ...
      <pre><code class="language-markup">${o.galeria}</code></pre>
    </div>
  </section>
  ...
  <section class="mod_section" id="mod_pasos">
    ...
    <div class="mod_code_wrap">
      <div class="mod_code_head"><span><i class="fas fa-code"></i> Código</span><span class="mod_lang">HTML + JS</span></div>
      <pre><code class="language-markup">${o.pasos}</code></pre>
    </div>
  </section>
  ...
  <section class="mod_section" id="mod_sizes">
    ...
    <div class="mod_code_wrap">
      ...
      <pre><code class="language-css">${o.sizes}</code></pre>
    </div>
  </section>
  ...
  <section class="mod_section" id="mod_posiciones">
    ...
    <div class="mod_code_wrap">
      <div class="mod_code_head"><span><i class="fas fa-code"></i> Código</span><span class="mod_lang">CSS</span></div>
      <pre><code class="language-css">${o.posiciones}</code></pre>
    </div>
  </section>
  ...
  <section class="mod_section" id="mod_animados">
    ...
    <div class="mod_code_wrap">
      <div class="mod_code_head"><span><i class="fas fa-code"></i> Código</span><span class="mod_lang">CSS</span></div>
      <pre><code class="language-css">${o.animados}</code></pre>
    </div>
  </section>
  ...
  <section class="mod_section" id="mod_api">
    ...
    <div class="mod_fns">${w.map(C).join("")}</div>
    ...
    <div class="mod_code_wrap">
      ...
      <pre><code class="language-js">${o.atajos}</code></pre>
    </div>
  </section>
...
</div>`,B=()=>{window.Prism&&Prism.highlightAll(),h("pre code"),a(document).on("click.mod","[data-open]",function(){_(a(this).data("open"))});let s=1;const r=3,n=()=>{a(".mod_step_panel").removeClass("active"),a(`.mod_step_panel[data-panel="${s}"]`).addClass("active"),a(".mod_step_dot").removeClass("active done"),a(".mod_step_dot").each(function(){const i=+a(this).data("s");i<s&&a(this).addClass("done"),i===s&&a(this).addClass("active")}),a(".mod_wiz_prev").css("visibility",s===1?"hidden":"visible"),a(".mod_wiz_next").html(s===r?'<i class="fas fa-check"></i> Finalizar':'<i class="fas fa-arrow-right"></i> Siguiente')};a(document).on("click.mod",".mod_wiz_next",()=>{s<r?(s++,n()):(e(),l("¡Wizard completado!","success"),s=1,n())}),a(document).on("click.mod",".mod_wiz_prev",()=>{s>1&&(s--,n())}),a(document).on("click.mod","#btnRegDemo",function(){d(this),setTimeout(()=>{d(this,!1),e(),l("¡Registro exitoso!","success")},1500)}),a(document).on("click.mod","#btnContactDemo",function(){d(this),setTimeout(()=>{d(this,!1),e(),l("¡Mensaje enviado!","success")},1200)}),a(document).on("click.mod","#btnLoginDemo",function(){d(this),setTimeout(()=>{d(this,!1),e(),g("¡Bienvenido!","success")},1500)}),a(document).on("click.mod","#btnDeleteConfirm",function(){e(),l("Elemento eliminado","success")}),a(document).on("click.mod","#btnLogoutConfirm",function(){e(),l("Sesión cerrada","info")}),a(document).on("click.mod",".mod_side_item",function(i){i.preventDefault(),a(".mod_side_item").removeClass("active"),a(this).addClass("active");const t=a(a(this).attr("href"));t.length&&a("html,body").animate({scrollTop:t.offset().top-80},400)});const f=a(".mod_section"),m=()=>{const i=a(window).scrollTop()+120;f.each(function(){const t=a(this),v=t.offset().top,b=v+t.outerHeight();if(i>=v&&i<b){const u=t.attr("id")?.replace("mod_","");a(".mod_side_item").removeClass("active"),a(`.mod_side_item[data-cat="${u}"]`).addClass("active")}})};a(window).on("scroll.mod",m),m(),a(".mod_side_item").first().addClass("active"),c(".mod_section",null,{anim:"wi_fadeUp",stagger:120}),c(".mod_feat",null,{anim:"wi_fadeUp",stagger:60}),c(".mod_info_card",null,{anim:"wi_fadeUp",stagger:80}),console.log(`⚡ ${y} ${x} · Modales OK`)},E=()=>{a(document).off(".mod"),a(window).off(".mod"),e()};export{E as cleanup,B as init,z as render};
