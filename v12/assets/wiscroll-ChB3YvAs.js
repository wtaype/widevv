import{j as c}from"./vendor-gzd0YkcT.js";import{k as l,w as t}from"./main-DFqobhrX.js";const i="#10B981",e={id:"wiscroll",fn:l,nom:"Scroll Spy",icon:"fa-location-arrow",color:i,desc:"Resalta el link de navegacion activo segun la seccion visible en pantalla. IntersectionObserver.",code:"wiScroll(['hero','about','contact'], '.nav-link');",demo:()=>`<div class="cp_demo_row wsc_demo_wrap">
    <nav class="wsc_nav">
