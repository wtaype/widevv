import{j as i}from"./vendor-gzd0YkcT.js";import{db as d}from"./firebase-CFRQlZyM.js";import{k as u,d as _}from"./firebase-BEkkiCuJ.js";import{t as m,f as c,s as v,M as e,w as b,j as h}from"./main-DsMaKeNy.js";const l=()=>h("wiSmile")||{},D=()=>{const a=l();if(!a.email)return location.replace("/"),"";const s=a.nombre||"",r=a.apellidos||"",p=a.usuario||"",f=a.email||"",o=a.rol||"smile",n=a.uid||"",t=a.imagen||"./smile.avif";return((s[0]||"")+(r[0]||"")).toUpperCase(),`
  <div class="prf_wrap">
